...
const getHeatmapColor = (value) => {
    ...
    // Calculate intensity (0 to 1) - more negative means higher intensity
    const intensity = Math.min(1, Math.abs(value) / 30000);

    // Map intensity directly to color
    // Light blue (220, 235, 255) for values close to zero
    // Dark blue (0, 30, 120) for highly negative values
    const r = Math.round(220 - (intensity * 220));
    const g = Math.round(235 - (intensity * 205));
...
const Analysis = () => {
    ...
    const runAnalysis = async () => {
        ...
        try {
            ...
            const strandData = strands.map(s => ({
                ...
                concentration: strandConcentrations[s.id] || "1e-7"
            }));
                ...
                for (let j = 0; j < strandData.length; j++) {
                    ...
                    try {
                        ...
                        row.push({
                            ...
                            strand1_seq: strandData[i].sequence,
                            strand2_seq: strandData[j].sequence,
                            strand1_conc: strandData[i].concentration,
                            strand2_conc: strandData[j].concentration,
    ...
    const exportResults = () => {
        ...
        a.href = url;
        a.download = 'nucleic_acid_analysis_results.json';
    ...
    return (
        <div className="container-fluid py-4">
            <h2 className="mb-4">Nucleic Acid Interaction Analysis</h2>
                            ...
                            <div className="row">
                                <div className="col-md-7">
                                    ...
                                    <p className="text-muted">
                                        ...
                                        More negative values (darker blue) indicate stronger binding potential.
                                        Cells with a melting temperature (Tm) above 30°C are highlighted with a gold
                                        border.
                                        Click on any cell to see structure details.
                                    </p>
                                                            ...
                                                            <td
                                                                ...
                                                                style={{
                                                                    ...
                                                                    border: selectedCell && selectedCell.rowIdx === rowIdx && selectedCell.cellIdx === cellIdx
                                                                        ? '2px solid black'
                                                                        : highTm ? '3px solid gold' : undefined
                                                                }}
                                                                title={`Click for structure details${highTm ? ' - Tm > 30°C' : ''}`}
                                                                onClick={() => handleCellClick(rowIdx, cellIdx)}
                                                            >
                                                                {cell.structure_found ? (
                                                                    <>
                                                                        {formatDeltaG(cell.dg)}
                                                                        {highTm && (
                                                                            <span
                                    ...
                                    <div className="mt-3">
                                        <div className="d-flex align-items-center mb-2">
                                            ...
                                            <div style={{
                                                width: '200px',
                                                height: '20px',
                                                background: 'linear-gradient(to right, rgb(248, 249, 250), rgb(180, 210, 255), rgb(0, 30, 120))'
                                            }}></div>
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <span className="ms-2">Melting temperature (Tm) above 30°C</span>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div className="card-body">
                                                <table className="table table-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span
                                                                className={selectedCell.data.tm > 30 ? 'fw-bold text-warning' : ''}>
                                                                {selectedCell.data.tm.toFixed(1)}
                                                                {selectedCell.data.tm > 30 && ' ★'}
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
